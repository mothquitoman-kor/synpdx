...
#' @param Di_vec named numeric vector of D_i (names = subject)
#' @param combo_df data.frame from synpdx_compute_Di() with columns subject,time,DV,predicted_logvol,cutoff
#' @param alpha alpha level for group test
#' @param out_dir optional directory to write CSV and PNG
#' @return list(overall, per_subject, plot)
#' @export
